    ...
    <header className="flex gap-2 sm:gap-4 flex-row sm:items-center justify-between sm:justify-between">
      ...
      <div className="flex items-center gap-2 self-start sm:self-center">
        <button
          ...
          type="button"
          className="inline-flex cursor-pointer items-center justify-center gap-2  bg-indigo-600 px-2.5 py-1.5 text-xs sm:px-4 sm:py-2.5 sm:text-sm font-medium text-white shadow-xs transition-colors hover:bg-indigo-700 active:bg-indigo-800 rounded-xl sm:rounded-2xl"
        >
